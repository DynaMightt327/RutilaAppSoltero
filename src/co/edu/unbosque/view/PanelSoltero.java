...
public class PanelSoltero extends JPanel {
	
	private JLabel titulo;
	private JButton emparejar;
	private JTable tablaSoltero;
	...
	public void iniComponentes() {
		...
		titulo = new JLabel("Solteros registrados esta noche");
		titulo.setBounds(20, 30, 500, 22);
		titulo.setFont(new Font("Arial", Font.BOLD, 20));
		titulo.setForeground(Color.white);
		add(titulo);
		
		String[] columnas = { "Nombre", "Apellido", "Género", "Edad", "Universidad"};
		DefaultTableModel modelo = new DefaultTableModel(columnas, 0);
		tablaSoltero = new JTable(modelo);
		tablaSoltero.setBackground(Color.decode("#fad0ce"));
		tablaSoltero.setForeground(Color.decode("#40110f"));
		tablaSoltero.getTableHeader().setBackground(Color.decode("#cd3a35"));
		tablaSoltero.getTableHeader().setForeground(Color.decode("#fdf3f3"));
		tablaSoltero.getColumnModel().getColumn(0).setPreferredWidth(160);
		tablaSoltero.getColumnModel().getColumn(1).setPreferredWidth(160);
		tablaSoltero.getColumnModel().getColumn(2).setPreferredWidth(100);
		tablaSoltero.getColumnModel().getColumn(3).setPreferredWidth(50);
		tablaSoltero.getColumnModel().getColumn(4).setPreferredWidth(200);
		JScrollPane scroll = new JScrollPane(tablaSoltero);
		scroll.setBounds(20, 70, 700, 300);
		scroll.setBackground(Color.decode("#fad0ce"));
		add(scroll);
		
		verDetalle = new JButton("Ver Detalles");
		verDetalle.setBounds(20, 420, 140, 40);
		verDetalle.setBackground(Color.decode("#efbfce"));
		verDetalle.setForeground(Color.black);
		verDetalle.setBorderPainted(false);
		verDetalle.setFocusPainted(false);
		//add(verDetalle);
		
		emparejar = new JButton("EMPAREJAR");
		emparejar.setBounds(20, 390, 140, 40);
		emparejar.setBackground(Color.decode("#efbfce"));
		emparejar.setForeground(Color.decode("#3d0b0d"));
		emparejar.setBorderPainted(false);
		emparejar.setFocusPainted(false);
		add(emparejar);
		
		//VER PERFIL A DETALLE
		mostrarDetalle = new JPanel();
		mostrarDetalle.setBounds(750, 15, 300, 420);
	...
	public JButton getEmparejar() {
		return emparejar;
	}

	public void setEmparejar(JButton emparejar) {
		this.emparejar = emparejar;
	}

	public JTable getTablaSoltero() {
		return tablaSoltero;
	}

	public void setTablaSoltero(JTable tablaSoltero) {
		this.tablaSoltero = tablaSoltero;
	}
	...
	public void setVerDetalle(JButton verDetalle) {
